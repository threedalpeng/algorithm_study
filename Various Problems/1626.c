...
// for representation of MST using linked list
typedef struct
{
    int to, weight;
} Point;
...
// for LCA
int par[20][MAX_VTX + 1];
int cost[20][MAX_VTX + 1];
int level[MAX_VTX + 1];
bool visit[MAX_VTX + 1];
